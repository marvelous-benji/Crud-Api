...
class TemplateList(MethodView):
    ...
    def post(self):
        ...
        try:
            ...
            template_obj.save()
            return (
                jsonify({"status": "success", "msg": "Template created successfully"}),
                201,
            )
    ...
    def get(self):
        ...
        try:
            ...
            return (
                jsonify({"status": "success", "templates": serializer.dump(templates)}),
                200,
            )
        except Exception as e:
            logger.error(e)
        ...
        try:
            ...
            if template:
                if template.owner.id == current_user.id:
                    ...
                    return jsonify({"status": "success", "template": serializer}), 200
                else:
                    return (
                        jsonify(
                            {
            ...
            return (
                jsonify(
                    {"status": "failed", "msg": "The requested template was not found"}
                ),
                404,
            )
        except Exception as e:
        ...
        try:
            ...
            if template:
                if template.owner.id == current_user.id:
                    ...
                    template.template_name = serialized_data.get(
                    ...
                    return (
                        jsonify(
                            {"status": "success", "template": serializer.dump(template)}
                        ),
                        200,
                    )
                else:
        ...
        try:
            ...
            if template:
                if template.owner.id == current_user.id:
                    ...
                    return (
                        jsonify(
                            {"status": "success", "msg": "Template deleted successfully"}
                        ),
                        200,
                    )
                else:
